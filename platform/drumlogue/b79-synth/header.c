...
const __unit_header unit_header_t unit_header = {
    ...
    .name = "b79",                                       // Name for this unit, will be displayed on device
    ...
    .params = {
        ...
        // Page 1
        {0, 127, 0, 0, k_unit_param_type_strings, 0, 0, 0, {"LFO Rate Z"}},
        {0, 127, 0, 0, k_unit_param_type_strings, 0, 0, 0, {"LFO Rate Y"}},
        {0, 127, 0, 0, k_unit_param_type_strings, 0, 0, 0, {"LFO Rate Z"}},
        {0, 127, 0, 0, k_unit_param_type_strings, 0, 0, 0, {"LFO Rate W"}},
