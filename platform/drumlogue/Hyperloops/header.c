...
const __unit_header unit_header_t unit_header = {
    ...
    .params = {
        ...
        {0, 10, 0, 6, k_unit_param_type_strings, 0, k_unit_param_frac_mode_fixed, 0, {"Length 1"}},
        {0, 10, 0, 6, k_unit_param_type_strings, 0, k_unit_param_frac_mode_fixed, 0, {"Length 2"}},
        {0, 10, 0, 6, k_unit_param_type_strings, 0, k_unit_param_frac_mode_fixed, 0, {"Length 3"}},
        {0, 10, 0, 6, k_unit_param_type_strings, 0, k_unit_param_frac_mode_fixed, 0, {"Length 4"}},
        {0, 10, 0, 6, k_unit_param_type_strings, 0, k_unit_param_frac_mode_fixed, 0, {"Length 5"}},
        {0, 10, 0, 6, k_unit_param_type_strings, 0, k_unit_param_frac_mode_fixed, 0, {"Length 6"}},
        {0, 10, 0, 6, k_unit_param_type_strings, 0, k_unit_param_frac_mode_fixed, 0, {"Length 7"}},
        {0, 10, 0, 6, k_unit_param_type_strings, 0, k_unit_param_frac_mode_fixed, 0, {"Length 8"}},
    }
};
